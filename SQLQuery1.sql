...
insert into Reservation(r_ID , r_CustomerName, r_LocationAddress , r_ModelNumber)
values (4 , 'yaseen' , 'alex.' , 1234);
...
insert into Reservation(r_ID , r_CustomerName, r_LocationAddress , r_ModelNumber)
values (9 , 'Mohamed' , 'kafr el_dawar' , 4321);
insert into Rental (e_ID , e_CustomerName , e_LocationAddress , e_ModelNumber , e_PickupDate , e_ReturnDate )
...
where Location.l_ID = Reservation.r_ID ;
...
delete from Location where l_Address = 'kafer el-dawar' ; 
